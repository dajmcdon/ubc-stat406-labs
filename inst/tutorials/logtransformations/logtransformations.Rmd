...
The following code computes the coefficient of variation for each of the four models.
...
quiz(caption="Question 4",
  question("Is it reasonable to compare the CV values for models 1 and 3 with those of models 2 and 4? Why or why not?",
    answer("Yes, Models 2 and 4 have a much lower CV and are thus better."),
    answer("Yes, Models 1 and 3 have a much higher CV and are thus better."),
    ...
    answer("Yes, the coefficient of variation corrects for any mismatch in scaling."),
    allow_retry = TRUE
  )
)
```
